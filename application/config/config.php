...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : '43e625bbc879afab50885e61c9f1e1016c5157a2299be776b86de43714a8d1cb';
...
$config['csrf_exclude_uris'] = array('login', 'api/register', 'api/login');
